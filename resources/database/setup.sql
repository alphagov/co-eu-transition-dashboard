...
VALUES
  ('Project 1','BEIS','issue',1,NULL,'SRC','description',NULL,NULL),
  ('Project 2','BEIS','issue',1,NULL,'SRC','description',NULL,NULL),
  ('Project 3','DFT','issue',1,NULL,'SRC','description',NULL,NULL),
  ('Project 4','DFT','issue',1,NULL,'SRC','description',NULL,NULL),
  ('Project 5','DFT','issue',1,NULL,'SRC','description',NULL,NULL),
  ('Project 6','DIT','issue',1,NULL,'SRC','description',NULL,NULL),
  ('Project 7','DIT','issue',1,NULL,'SRC','description',NULL,NULL),
  ('Project 8','DIT','issue',1,NULL,'SRC','description',NULL,NULL),
  ('Project 9','BEIS','issue',1,NULL,'SRC','description',NULL,NULL),
  ('Project 10','BEIS','issue',1,NULL,'SRC','description',NULL,NULL);
...
VALUES
  ...
  (2,'Project 1',X'33',NULL,NULL),
  (3,'Project 1',X'31',NULL,NULL),
  (4,'Project 1',X'31',NULL,NULL),
  (1,'Project 2',X'31',NULL,NULL),
  (2,'Project 2',X'33',NULL,NULL),
  (3,'Project 2',X'31',NULL,NULL),
  (4,'Project 2',X'31',NULL,NULL),
  (1,'Project 3',X'31',NULL,NULL),
  (2,'Project 3',X'33',NULL,NULL),
  (3,'Project 3',X'31',NULL,NULL),
  (4,'Project 3',X'31',NULL,NULL),
  (1,'Project 4',X'31',NULL,NULL),
  (2,'Project 4',X'33',NULL,NULL),
  (3,'Project 4',X'31',NULL,NULL),
  (4,'Project 4',X'31',NULL,NULL),
  (1,'Project 5',X'31',NULL,NULL),
  (2,'Project 5',X'33',NULL,NULL),
  (3,'Project 5',X'31',NULL,NULL),
  (4,'Project 5',X'31',NULL,NULL),
  (1,'Project 6',X'31',NULL,NULL),
  (2,'Project 6',X'33',NULL,NULL),
  (3,'Project 6',X'31',NULL,NULL),
  (4,'Project 6',X'31',NULL,NULL),
  (1,'Project 7',X'31',NULL,NULL),
  (2,'Project 7',X'33',NULL,NULL),
  (3,'Project 7',X'31',NULL,NULL),
  (4,'Project 7',X'31',NULL,NULL),
  (1,'Project 8',X'31',NULL,NULL),
  (2,'Project 8',X'33',NULL,NULL),
  ...
  (4,'Project 9',X'31',NULL,NULL),
  (1,'Project 10',X'31',NULL,NULL),
  (2,'Project 10',X'33',NULL,NULL),
  (3,'Project 10',X'31',NULL,NULL),
  (4,'Project 10',X'31',NULL,NULL);
